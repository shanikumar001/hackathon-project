...
import HelpPage from "./HelpingPage.jsx";
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Button
                asChild
                size="lg"
                className="h-14 px-8 rounded-2xl shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 transition-all text-base font-semibold"
              >
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="h-14 px-8 rounded-2xl border-2 hover:bg-muted text-base font-semibold"
              >
                <Link to="/dashboard">{t("home.startSelling")}</Link>
              </Button>
            </div>
          </motion.div>
        ...
        <div className="container px-6 mx-auto">
          ...
          >
            {[
              ...
              >
                <div
                  className={`w-16 h-16 rounded-2xl ${step.color} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}
                >
                  {step.icon}
                </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <motion.div {...fadeInUp} className="lg:w-1/2 space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Advanced tools designed for regional agriculture. We bridge the
                linguistic and digital divide.
              </p>
              ...
              >
                <div className="aspect-[3/4] rounded-3xl bg-farm-amber p-6 flex flex-col justify-between">
                  ...
                  <div className="space-y-1">
                    <p className="text-3xl font-display font-bold text-farm-earth">
                      100%
                    </p>
                    <p className="text-xs font-bold uppercase tracking-widest text-farm-earth/60">
                      Direct Trade
                    </p>
                  </div>
                </div>
                <div className="aspect-square rounded-3xl overflow-hidden shadow-lg border border-border">
                  <img
                    src="https://images.pexels.com/photos/12922925/pexels-photo-12922925.jpeg"
                    alt="Farmer"
                    className="w-full h-full object-cover"
                  />
                </div>
